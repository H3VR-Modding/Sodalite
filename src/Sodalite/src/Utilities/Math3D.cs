...
namespace Sodalite.Utilities
{
	...
	public static class Math3D
	{
		...
		/// </summary>
		public static float SignedDistancePlanePoint(Vector3 planeNormal, Vector3 planePoint, Vector3 point) => Vector3.Dot(planeNormal, point - planePoint);


		/// <summary>
		/// create a vector of direction "vector" with length "size"
		/// </summary>
		public static Vector3 SetVectorLength(Vector3 vector, float size) => Vector3.Normalize(vector) * size;
